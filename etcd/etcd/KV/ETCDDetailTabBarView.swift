    ...
    var body: some View {
        GeometryReader { proxy in
            AxisTabView(selection: $selection, constant: constant) { state in
                ...
                ETCDControlView(selection: $selection, constant: $constant, color: $color, client:client, tag: 0, systemName: "antenna.radiowaves.left.and.right",systemTitle:"KV" ,safeArea: proxy.safeAreaInsets)
