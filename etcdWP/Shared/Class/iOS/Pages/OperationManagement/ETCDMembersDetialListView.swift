//
//  ETCDMembersDetialListView.swift
//  etcdWP (iOS)
//
//  Created by FaceBook on 2022/9/3.
//
...
let MembersDetialListRouterName = "MembersDetialLists"

struct ETCDMembersDetialListView: View {
...
struct ETCDMembersDetialListContentView: View {
