...
struct KVOperateModel: Identifiable,Hashable {
    ...
    static  func getItems() -> [KVOperateModel]{
        let operateModels : [KVOperateModel] = [
            ...
            KVOperateModel.init(name: "租约管理", english: "（LeaseManager）",type: 2),
            KVOperateModel.init(name: "角色管理", english: "（RoleManager）",type: 3),
            KVOperateModel.init(name: "用户管理", english: "（UserManager）",type: 4),
